...
pretrianed_vit = torchvision.models.vit_h_14(weights=pretrained_vit_weights).to(device)
...
pretrianed_vit.heads = nn.Linear(in_features=1280, out_features=len(class_names)).to(device)
...
train(pretrianed_vit, train_dataloader, val_dataloader, test_dataloader, optimizer, loss_fn, EPOCHS, early_stopper_paitence=10)
