...
pretrianed_vit = torchvision.models.vit_l_16(weights=pretrained_vit_weights).to(device)
...
pretrianed_vit.heads = nn.Linear(in_features=1024, out_features=len(class_names)).to(device)
